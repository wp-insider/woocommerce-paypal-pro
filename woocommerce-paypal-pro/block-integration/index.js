...
/***/ "./src/blocks/wcpprog-payment-gateway-integration/Constants.js":
/*!*********************************************************************!*\
  !*** ./src/blocks/wcpprog-payment-gateway-integration/Constants.js ***!
  \*********************************************************************/
...
/* harmony export */ });
const PAYMENT_METHOD_NAME = "paypalpro";

/***/ }),

/***/ "./src/blocks/wcpprog-payment-gateway-integration/FrontEndContent.js":
/*!***************************************************************************!*\
  !*** ./src/blocks/wcpprog-payment-gateway-integration/FrontEndContent.js ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function CardTypeSelect({
  onBillingCardTypeChange
}) {
  const [state, setState] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)('Visa');
 ...
 */
function ExpYearSelect({
  onBillingExpYearChange
}) {
  const date = new Date();
  ...
  const [state, setState] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(year);
  const handleStateChange = event => {
    const inputValue = event.target.value;
    setState(inputValue);
...
const FrontEndContent = props => {
  ...
  const [billingCreditCard, setBillingCreditCard] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)("");
  const [billingCvvNumber, setBillingCvvNumber] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)("");
  const [billingCardType, setBillingCardType] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)("");
  const [billingExpMonth, setBillingExpMonth] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)("");
  const [billingExpYear, setBillingExpYear] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)("");
  const card_no_input_placeholder = (0,_Utils__WEBPACK_IMPORTED_MODULE_2__.getSettings)('card_number_field_placeholder');
  const cvv_field_placeholder = (0,_Utils__WEBPACK_IMPORTED_MODULE_2__.getSettings)('cvv_field_placeholder');
...
/***/ "./src/blocks/wcpprog-payment-gateway-integration/Utils.js":
/*!*****************************************************************!*\
  !*** ./src/blocks/wcpprog-payment-gateway-integration/Utils.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/wcpprog-payment-gateway-integration/FrontEndContent.module.css":
/*!***********************************************************************************!*\
  !*** ./src/blocks/wcpprog-payment-gateway-integration/FrontEndContent.module.css ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"paypalpro":"ClsRKAjaHnXu5J8nR9mK","formRow":"u63zC9czgvZoDOeZwVFw","requiredMark":"ZY71SmIEzHQtLndUO4rK","cvvHintWrap":"eC5U1HK5KmPTSZU4A_Yj"});
...
/*!*****************************************************************!*\
  !*** ./src/blocks/wcpprog-payment-gateway-integration/index.js ***!
  \*****************************************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _FrontEndContent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./FrontEndContent */ "./src/blocks/wcpprog-payment-gateway-integration/FrontEndContent.js");
/* harmony import */ var _Utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Utils */ "./src/blocks/wcpprog-payment-gateway-integration/Utils.js");
/* harmony import */ var _Constants_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Constants.js */ "./src/blocks/wcpprog-payment-gateway-integration/Constants.js");
...
const EditPageContent = () => {
  return (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_0__.decodeEntities)((0,_Utils__WEBPACK_IMPORTED_MODULE_2__.getSettings)('description', __('Credit / Debit card accept form will render in the front-end.', 'woocommerce-paypal-pro-payment-gateway')));
};
const labelText = (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_0__.decodeEntities)((0,_Utils__WEBPACK_IMPORTED_MODULE_2__.getSettings)('title'));
const Label = props => {
  const {
    PaymentMethodLabel,
    PaymentMethodIcons
  } = props.components;
  const cardIcons = (0,_Utils__WEBPACK_IMPORTED_MODULE_2__.getSettings)('cardIcons').map(icon => {
    return {
      id: icon.id,
      alt: icon.alt,
      src: icon.src
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(PaymentMethodLabel, {
      text: labelText
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(PaymentMethodIcons, {
      icons: cardIcons,
      align: "right"
    })]
  });
...
registerPaymentMethod({
  name: _Constants_js__WEBPACK_IMPORTED_MODULE_3__.PAYMENT_METHOD_NAME,
  label: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(Label, {}),
  content: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_FrontEndContent__WEBPACK_IMPORTED_MODULE_1__["default"], {}),
  edit: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(EditPageContent, {}),
  canMakePayment: () => true,
  ariaLabel: labelText,
  supports: {
    features: (0,_Utils__WEBPACK_IMPORTED_MODULE_2__.getSettings)('supports', [])
  }
